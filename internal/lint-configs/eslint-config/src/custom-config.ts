...
const customConfig: Linter.Config[] = [
  ...
  // Removed most import restrictions - only keeping critical architectural boundaries
  // {
  //   // apps内部的一些基础规则 - DISABLED for more flexibility
  //   files: ['apps/**/**'],
  //   ignores: restrictedImportIgnores,
  //   rules: {
  ...
  // },
  // {
  //   // @core内部组件，不能引入@vben/* 里面的包 - DISABLED for more flexibility
  //   files: ['packages/@core/**/**'],
  //   ignores: restrictedImportIgnores,
  //   rules: {
  //     'no-restricted-imports': [
  ...
  // },
  // {
  //   // @core/shared内部组件，不能引入@vben/* 或者 @vben-core/* 里面的包 - DISABLED for more flexibility
  ...
  // {
  //   // 不能引入@vben/*里面的包 - DISABLED for more flexibility
  //   files: [
  //     'packages/types/**/**',
  //     'packages/utils/**/**',
  //     'packages/icons/**/**',
