<template>
  <div class="hk-pc4-form-template bg-white p-6 text-sm">
    <!-- Form Header -->
    <div class="mb-6">
      <div class="bg-gray-600 px-4 py-2 text-center text-white">
        <div class="text-lg font-bold">
          HK-PC4: COMPUTATION OF STATUTORY INCOME FOR A COMPANY WHICH HAS BEEN
        </div>
        <div class="text-lg font-bold">
          GRANTED INVESTMENT TAX ALLOWANCE (ITA) INCENTIVE/P.U. (A) 370/2021
        </div>
      </div>
    </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <template v-else>
              <div class="pdf-text-only w-32 border border-gray-400 px-2 py-1 text-center text-sm">TIN Number</div>
            </template>
          </div>
        </div>
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <template v-else>
              <div class="pdf-text-only w-40 border border-gray-400 px-2 py-1 text-center text-sm">Registration Number</div>
            </template>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="ml-4 flex space-x-2">
            <div v-for="i in 5" :key="i" class="flex flex-col items-center">
              ...
              <template v-else>
                <div class="h-4 w-4 border border-gray-400 bg-white pdf-text-only"></div>
              </template>
        ...
        <div class="flex items-center">
          <label class="font-medium">Year of Assessment</label>
            ...
            <template v-else>
              <div class="pdf-text-only w-16 border border-gray-400 px-2 py-1 text-center text-sm">Year</div>
            </template>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <template v-else>
              <div class="pdf-text-only w-80 border border-gray-400 px-2 py-1 text-sm">Business Activity Description</div>
            </template>
          </div>
        </div>
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <template v-else>
              <div class="pdf-text-only w-20 border border-gray-400 px-2 py-1 text-center text-sm">Code</div>
            </template>
          </div>
        </div>
      </div>
    ...
    <!-- Section D: Computation of Claim on Investment Tax Allowance -->
    <div class="mb-6">
      <div class="mb-4">
        <div class="flex items-center">
          <span class="mr-4 font-bold">D.</span>
          <span class="font-medium"
            >COMPUTATION OF CLAIM ON INVESTMENT TAX ALLOWANCE (ITA)/P.U. (A)
            370/2021</span
          >
        </div>
      </div>
      ...
      <div class="ml-8 space-y-4">
        <div class="flex items-center justify-between">
          <span>1. Balance of ITA brought forward</span>
          <template v-if="!isPdfExport">
            <input
              type="number"
              readonly
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <span>2. ITA for current year:</span>
            <template v-if="!isPdfExport">
              <input
                type="number"
                readonly
                class="ml-4 w-20 border border-gray-400 px-2 py-1 text-right text-sm focus:outline-none"
                placeholder="0"
              />
            </template>
            <template v-else>
              <div class="pdf-text-only ml-4 w-20 border border-gray-400 px-2 py-1 text-right text-sm">0</div>
            </template>
            <span class="mx-2">%</span>
            <span class="mx-2">x</span>
            <span class="mx-2">C</span>
            <span class="mx-2">=</span>
          </div>
          <template v-if="!isPdfExport">
            <input
    ...
    <!-- Section F: Investment Tax Allowance absorbed -->
    <div class="mb-6">
      <div class="flex items-center justify-between border-b border-black pb-2">
        <div class="flex items-center">
          <span class="mr-4 font-bold">F.</span>
          <span class="font-medium">Investment Tax Allowance absorbed</span>
        </div>
        <template v-if="!isPdfExport">
          <template v-if="!isPdfExport">
            <input
    ...
    <div class="mt-8 text-center">
      <span class="font-bold">HK-PC4 1/2</span>
    </div>
    ...
    <!-- Page 2 Content -->
    <!-- Section H: Adjustment of Investment Tax Allowance -->
    <div class="mb-6">
      <div class="mb-4">
        <div class="flex items-center">
          <span class="mr-4 font-bold">H.</span>
          <span class="font-medium"
            >ADJUSTMENT OF INVESTMENT TAX ALLOWANCE/P.U. (A) 370/2021</span
          >
        </div>
      </div>
      ...
      <div class="ml-8 space-y-4">
        ...
        <div class="flex items-center justify-between">
          <span>2. Current year claim</span>
          <input
            type="number"
            readonly
            class="w-32 border border-gray-400 px-2 py-1 text-right text-sm focus:outline-none"
        ...
        <div class="flex items-center justify-between">
          <div>
            <span>4. Claim absorbed in the current year</span><br />
        ...
        <div class="flex items-center justify-between">
          <span>5. Balance carried forward (H3 - H4)</span>
          <input
            type="number"
            readonly
            class="w-32 border border-gray-400 px-2 py-1 text-right text-sm focus:outline-none"
    ...
    <div class="mb-6">
      ...
      <div class="ml-8 space-y-4">
        ...
        <div class="flex items-center justify-between">
          ...
          <template v-else>
            <div class="pdf-text-only w-24 border border-gray-400 px-2 py-1 text-right text-sm">0.00</div>
          </template>
        </div>
    ...
    <!-- Form Footer Page 2 -->
    <div class="mt-8 text-center">
      <span class="font-bold">HK-PC4 2/2</span>
    </div>
  </div>
</template>

<script lang="ts" setup>
// HK-PC4 Form Template - Computation of Statutory Income for Company with ITA Incentive
